...
func TestBaseViewerMocked(t *testing.T) {
	configurator.FixtureMigrator(func(dbpath types.Dbpath) {
		...
		record.Add(base.NewBase2(base.Base{Name: "Station2", Affiliation: "Qwe", Health: 100}))
		...
		record = records.NewStampedObjects[*configs_export.PoB]()
		record.Add(base.NewBase2(base.Base{Name: "Bank of Bretonia", Affiliation: "Abc", Health: 100}))
		scrapper.GetBaseStorage().Add(record)
...
func TestDetectAttackOnLPBase(t *testing.T) {
	configurator.FixtureMigrator(func(dbpath types.Dbpath) {
		...
		record := records.NewStampedObjects[*configs_export.PoB]()
		record.Add(base.NewBase2(base.Base{Name: "LP-7743", Affiliation: "Abc", Health: 5}))
		bases.Add(record)
		record2 := records.NewStampedObjects[*configs_export.PoB]()
		record2.Add(base.NewBase2(base.Base{Name: "LP-7743", Affiliation: "Abc", Health: 6}))
